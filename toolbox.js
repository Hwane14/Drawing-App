...
function Toolbox() {
	...
	var addToolIcon = function(icon, name) {
		...
		sideBarItem.parent("sidebar");// Puts created element within div that has the ID "sidebar"
		sideBarItem.mouseClicked(toolbarItemClick);// Event handler for when the tool is clicked
